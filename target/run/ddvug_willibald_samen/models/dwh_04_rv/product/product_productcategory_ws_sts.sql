        ...
        create or replace  table WILLIBALD_DATA_VAULT_WITH_DBT.dwh_04_rv.product_productcategory_ws_sts
         as
        (
...
cte_current_sts as
(
    select    '00000000000000000000000000000000' as hk_product_productcategory_l
            , '' rsrc
