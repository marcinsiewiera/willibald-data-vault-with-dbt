        ...
        create or replace  table WILLIBALD_DATA_VAULT_WITH_DBT.dwh_04_rv.order_associationpartner_rs_sts
         as
        (
...
cte_current_sts as
(
    select    '00000000000000000000000000000000' as hk_order_associationpartner_l
            , '' rsrc
