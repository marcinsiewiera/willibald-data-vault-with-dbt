        ...
        create or replace  table WILLIBALD_DATA_VAULT_WITH_DBT.dwh_04_rv.productcategory_hierarchy_ws_sts
         as
        (
...
cte_current_sts as
(
    select    '00000000000000000000000000000000' as hk_productcategory_hierarchy_l
            , '' rsrc
