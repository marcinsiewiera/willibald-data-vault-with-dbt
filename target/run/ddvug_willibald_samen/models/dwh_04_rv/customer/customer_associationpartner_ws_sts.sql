        ...
        create or replace  table WILLIBALD_DATA_VAULT_WITH_DBT.dwh_04_rv.customer_associationpartner_ws_sts
         as
        (
...
cte_current_sts as
(
    select    '00000000000000000000000000000000' as hk_customer_associationpartner_l
            , '' rsrc
