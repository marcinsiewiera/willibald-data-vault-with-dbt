  ...
  create or replace   view WILLIBALD_DATA_VAULT_WITH_DBT.dwh_06_bv.productcategory_bs
...
(
    ...
    "PRODUCTCATEGORY_ID_L3" COMMENT $$$$, 
  
    "PRODUCTCATEGORY_L3" COMMENT $$$$, 
  
    "PRODUCTCATEGORY_L2" COMMENT $$$$, 
  
    "PRODUCTCATEGORY_ID_L2" COMMENT $$$$, 
  
    "PRODUCTCATEGORY_L1" COMMENT $$$$, 
  
    "PRODUCTCATEGORY_ID_L1" COMMENT $$$$
