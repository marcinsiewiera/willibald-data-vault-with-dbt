  ...
  create or replace   view WILLIBALD_DATA_VAULT_WITH_DBT.dwh_06_bv.category_deliveryadherence_bs
  
    
    
(
  
    "NUMBER_OF_DAYS_FROM_NUM" COMMENT $$$$, 
  
    "NUMBER_OF_DAYS_TILL_NUM" COMMENT $$$$, 
  
    "NUMBER_OF_DAYS_FROM" COMMENT $$$$, 
  
    "NUMBER_OF_DAYS_TILL" COMMENT $$$$, 
