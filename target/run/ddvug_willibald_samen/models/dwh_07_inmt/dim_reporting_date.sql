  ...
  create or replace   view WILLIBALD_DATA_VAULT_WITH_DBT.dwh_07_inmt.dim_reporting_date
  
    
    
(
  
    "REPORTING_DATE" COMMENT $$$$, 
  
    "REPORTING_MONTH" COMMENT $$$$, 
  
    "REPORTING_YEAR" COMMENT $$$$, 
  
    "REPORTING_WEEK" COMMENT $$$$
