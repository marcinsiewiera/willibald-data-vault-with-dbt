  ...
  create or replace   view WILLIBALD_DATA_VAULT_WITH_DBT.dwh_07_inmt.dim_requested_date
  
    
    
(
  
    "REQUESTED_DATE" COMMENT $$$$, 
  
    "REQUESTED_MONTH" COMMENT $$$$, 
  
    "REQUESTED_YEAR" COMMENT $$$$, 
  
    "REQUESTED_WEEK" COMMENT $$$$
