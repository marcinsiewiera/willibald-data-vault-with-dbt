  ...
  create or replace   view WILLIBALD_DATA_VAULT_WITH_DBT.dwh_05_sn.order_position_sns
...
(
    ...
    "HK_ORDER_POSITION_D" COMMENT $$$$, 
  
    "HK_POSITION_H" COMMENT $$$$, 
  
    "HK_ORDER_H" COMMENT $$$$, 
  
    "LDTS_ORDER_POSITION_RS_STS" COMMENT $$$$, 
  
    "RSRC_ORDER_POSITION_RS_STS" COMMENT $$$$, 
  
    "LDTS_ORDER_POSITION_WS_STS" COMMENT $$$$, 
  
    "RSRC_ORDER_POSITION_WS_STS" COMMENT $$$$
