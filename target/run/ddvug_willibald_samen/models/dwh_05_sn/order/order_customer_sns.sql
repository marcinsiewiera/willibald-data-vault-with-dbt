  ...
  create or replace   view WILLIBALD_DATA_VAULT_WITH_DBT.dwh_05_sn.order_customer_sns
...
(
    ...
    "HK_ORDER_CUSTOMER_D" COMMENT $$$$, 
  
    "HK_ORDER_H" COMMENT $$$$, 
  
    "HK_CUSTOMER_H" COMMENT $$$$, 
  
    "LDTS_ORDER_CUSTOMER_RS_ES" COMMENT $$$$, 
  
    "RSRC_ORDER_CUSTOMER_RS_ES" COMMENT $$$$, 
  
    "LDTS_ORDER_CUSTOMER_WS_ES" COMMENT $$$$, 
  
    "RSRC_ORDER_CUSTOMER_WS_ES" COMMENT $$$$
