  ...
  create or replace   view WILLIBALD_DATA_VAULT_WITH_DBT.dwh_05_sn.order_sns
...
(
    ...
    "HK_ORDER_H_2" COMMENT $$$$, 
  
    "HD_ORDER_WS_S" COMMENT $$$$, 
  
    "RSRC" COMMENT $$$$, 
  
    "LDTS" COMMENT $$$$, 
  
    "ALLGLIEFERADRID" COMMENT $$$$, 
  
    "BESTELLDATUM" COMMENT $$$$, 
    ...
    "LDTS_ORDER_RS_STS" COMMENT $$$$, 
  
    "RSRC_ORDER_RS_STS" COMMENT $$$$, 
  
    "LDTS_ORDER_WS_STS" COMMENT $$$$, 
  
    "RSRC_ORDER_WS_STS" COMMENT $$$$
