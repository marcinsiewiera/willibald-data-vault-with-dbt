  ...
  create or replace   view WILLIBALD_DATA_VAULT_WITH_DBT.dwh_05_sn.position_product_sns
...
(
    ...
    "HK_POSITION_PRODUCT_D" COMMENT $$$$, 
  
    "HK_PRODUCT_H" COMMENT $$$$, 
  
    "HK_POSITION_H" COMMENT $$$$, 
  
    "LDTS_POSITION_PRODUCT_RS_ES" COMMENT $$$$, 
  
    "RSRC_POSITION_PRODUCT_RS_ES" COMMENT $$$$, 
  
    "LDTS_POSITION_PRODUCT_WS_ES" COMMENT $$$$, 
  
    "RSRC_POSITION_PRODUCT_WS_ES" COMMENT $$$$
