  ...
  create or replace   view WILLIBALD_DATA_VAULT_WITH_DBT.dwh_05_sn.associationpartner_customer_sns
...
(
    ...
    "HK_ASSOCIATIONPARTNER_CUSTOMER_D" COMMENT $$$$, 
  
    "HK_CUSTOMER_H" COMMENT $$$$, 
  
    "HK_ASSOCIATIONPARTNER_H" COMMENT $$$$, 
  
    "LDTS_ASSOCIATIONPARTNER_CUSTOMER_WS_ES" COMMENT $$$$, 
  
    "RSRC_ASSOCIATIONPARTNER_CUSTOMER_WS_ES" COMMENT $$$$
