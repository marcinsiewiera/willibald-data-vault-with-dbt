  ...
  create or replace   view WILLIBALD_DATA_VAULT_WITH_DBT.dwh_05_sn.associationpartner_sns
...
(
    ...
    "HK_ASSOCIATIONPARTNER_D" COMMENT $$$$, 
  
    "ASSOCIATIONPARTNER_BK" COMMENT $$$$, 
  
    "HK_ASSOCIATIONPARTNER_H_2" COMMENT $$$$, 
    ...
    "LDTS_ASSOCIATIONPARTNER_WS_STS" COMMENT $$$$, 
  
    "RSRC_ASSOCIATIONPARTNER_WS_STS" COMMENT $$$$
