  ...
  create or replace   view WILLIBALD_DATA_VAULT_WITH_DBT.dwh_05_sn.deliveryservice_sns
...
(
    ...
    "HK_DELIVERYSERVICE_D" COMMENT $$$$, 
  
    "DELIVERYSERVICE_BK" COMMENT $$$$, 
  
    "HK_DELIVERYSERVICE_H_2" COMMENT $$$$, 
    ...
    "LDTS_DELIVERYSERVICE_WS_STS" COMMENT $$$$, 
  
    "RSRC_DELIVERYSERVICE_WS_STS" COMMENT $$$$
