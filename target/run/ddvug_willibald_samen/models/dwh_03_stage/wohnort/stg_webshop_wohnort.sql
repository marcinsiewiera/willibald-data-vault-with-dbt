  ...
  create or replace   view WILLIBALD_DATA_VAULT_WITH_DBT.dwh_03_stage.stg_webshop_wohnort
...
(
    ...
    "IS_VON_TYPE_OK" COMMENT $$$$, 
  
    "IS_BIS_TYPE_OK" COMMENT $$$$, 
  
    "IS_DUB_CHECK_OK" COMMENT $$$$, 
  
    "IS_KUNDEID_KEY_CHECK_OK" COMMENT $$$$, 
  
    "IS_VON_KEY_CHECK_OK" COMMENT $$$$, 
