  ...
  create or replace   view WILLIBALD_DATA_VAULT_WITH_DBT.dwh_03_stage.stg_webshop_bestellung
...
(
    ...
    "IS_ALLGLIEFERADRID_TYPE_OK" COMMENT $$$$, 
  
    "IS_BESTELLDATUM_TYPE_OK" COMMENT $$$$, 
  
    "IS_WUNSCHDATUM_TYPE_OK" COMMENT $$$$, 
